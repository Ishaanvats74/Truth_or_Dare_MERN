...
const Home = () => {
  ...
  return (
    <div>
      <>
        <div
          className={`flex flex-col bg-black xs:h-auto md:min-h-screen  space-y-16`}
        >
          ...
          <div className="flex justify-center ">
            <span className="text-xl text-white/70 sm:text-sm sm:px-20 sm:text-center">
              The ultimate party game that brings friends closer together. Are
              you ready to reveal secrets and take on wild challenges?
            </span>
          </div>
          <div className="flex justify-center">
            <button
          ...
          <footer className="flex justify-center mt-auto text-white/80">
            <div>
              Join millions of players worldwide * No downloads required *
              Instant fun
            </div>
          </footer>
        </div>
        ...
        {startGame && (
          ...
          >
            <div
              className="bg-black rounded-2xl p-8 w-96 text-center space-y-6 shadow-2xl"
